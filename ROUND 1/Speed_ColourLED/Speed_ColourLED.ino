...
void loop()
{
  ...
  if (millis() - lastTime > 1000)
  {
    ...
    MATRIX.beginDraw();
    if ((speed >= 0) & (ratio_speed < 15))  MATRIX.fill(0, 255, 0); // Green
    if ((speed >= 16) & (ratio_speed < 20)) MATRIX.fill(255, 255, 0); // Yellow
    if ((speed >= 21) & (ratio_speed < 40)) MATRIX.fill(255, 0, 0); // Red
